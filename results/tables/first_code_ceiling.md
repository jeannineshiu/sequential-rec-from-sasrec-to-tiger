...
|---|---|---|---|---|
| 0 (as trained) | 12,096 | 0.0250 | 0.0131 | — |
| 1 | 51 | 0.3119 | 0.1627 | +1145% |
| 2 | 2 | 0.9879 | 0.7765 | +3845% |
| 3 | 1 | 1.0000 | 0.9457 | +3893% |

Handing over the level-1 code alone multiplies HR@10 by **12.5x** (0.0250 -> 0.3119).

But it does not rescue the model: with the right region and a median of 51 candidates left, **69% of targets still miss the top 10**. Level 2 is where retrieval actually becomes reliable (0.9879 from a median of 2 candidates). So the first code is not a lone bottleneck -- selecting the region and ranking within it are both weak.
...
| in top-10 | 5,291 | 0.0556 |
| in top-64 | 8,154 | 0.0083 |
| outside top-64 | 6,736 | 0.0001 |

Even when the model's own first choice of level-1 code is correct, unaided HR@10 is only **0.0903** -- the residual loss is inside the region, not in reaching it.
